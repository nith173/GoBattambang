<div>
    ...
    class="fixed inset-0 z-[99999] items-center justify-center bg-black/20"
>
    <div class="flex items-center gap-3 rounded-xl bg-white px-5 py-3 shadow-xl ring-1 ring-slate-200">
        <svg
